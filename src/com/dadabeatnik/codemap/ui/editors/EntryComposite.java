...
/**
 * Compoiste for an Entry
 * 
 * @author Phillip Beauvoir
 */
public class EntryComposite extends Composite implements ModifyListener {
    ...
    public EntryComposite(CodeMapEditor editor, Composite parent) {
        ...
        Composite fieldsComposite = toolkit.createComposite(this);
        ...
        Composite tableComposite = toolkit.createComposite(this);
